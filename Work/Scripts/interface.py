...
class MainWindow(QMainWindow):
    def __init__(self, user_list: UserCollection, current_user):
        ...
        self.groupBox.setGeometry(QtCore.QRect(0, 10, 1041, 491))
        ...
        self.addSmthBox.setGeometry(QtCore.QRect(380, 40, 401, 431))
        ...
        self.addHuman_groupBox.setGeometry(QtCore.QRect(220, 220, 131, 41))
        ...
        self.viewInvOrUserBox.setGeometry(QtCore.QRect(380, 40, 661, 341))
        ...
        self.searchByNameOrEmailLineEdit.setGeometry(QtCore.QRect(90, 30, 311, 22))
    ...
    def openPeopleViewer(self):
        ...
        self.listLabel.setWindowTitle("Все пользователи")
        self.searchByIdSpinBox.hide()
        self.searchByEmailOrNameLabel.setText("Email")
        self.SearchByRightsLabel.setText("Права на получение")
        ...
        self.searchByFirstRightsCheckBox.setText("Простейшее оборудование")
        self.searchBySecondRightsCheckBox.setText("Только в рамках проекта")
        self.searchByThirdRightsCheckBox.setText("Сложное оборуд.")
        self.searchByFourthRightsCheckBox.setText("Любое")
    def openEqViewer(self):
        ...
        self.listLabel.setWindowTitle("Весь инвентарь")
